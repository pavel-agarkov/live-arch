...
```mermaid
flowchart LR
    A[Structurizr<br/>DSL]
    B[Structurizr<br/>JSON model]
    C[Structurizr<br/>.NET model in memory]
    D[Walk deployment<br/>graph]
    E[Create Pulumi<br/>resources]
    F[Bind DSL<br/>properties]
