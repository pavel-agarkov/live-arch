...
Pulumi is an Infrastructure as Code platform that lets me define infrastructure in a normal programming language, like C#, TypeScript, Python, etc...
...
<!--
These are the core concepts Pulumi is built on.
- A resource is the cloud object to create or manage.
...
- Stack represents one set of resources managed together and its state.
...
<!--
So why Pulumi attracted me before I even connected it with Structurizr.  
I liked:
- that it was strongly typed in C#.
- that I could reuse normal code instead of only copying infrastructure snippets.
- that cloud providers were exposed through packages with resources, invokes, inputs, and outputs.
- that I could test and debug things with normal language tooling.
